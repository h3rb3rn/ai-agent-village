...
RELEASE_FILES = [
    ...
    ("web/event_history.py", "lib/event_history.py", 0o644),
    ...
    ("village/research_tasks.py", "lib/village/research_tasks.py", 0o644),
    ("village/rollout.py", "lib/village/rollout.py", 0o644),
    ("village/lineage.py", "lib/village/lineage.py", 0o644),
    ("village/recovery.py", "lib/village/recovery.py", 0o644),
